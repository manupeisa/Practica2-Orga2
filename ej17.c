...
/*En este prpgrama produzco memory leaks en el main al:
-Finalizar de usar mi lista enlazada y no eliminarla con la funcion deleteList por lo q no libero la memoria
-Cuando hago listRemove me elimina los valores f1 y f2 pero esto tambien me devuevle un data el cual produce que se quede en la memoria 
-*/